...
"use strict";
const EE_ERROR =
  "Registering more than one listener to a WebSocket is not supported.";
...
class WebSocket {
  ...
  get _socket() {
    const address = this.external
      ? native.getAddress(this.external)
      : new Array(3);
    return {
  ...
  send(message, options, cb) {
    if (this.external) {
      ...
      const binary =
        options && typeof options.binary === "boolean"
          ? options.binary
